import { RequestHandlerClass, RequestMethod, Data, RequestOptions } from './RequestHandler';
...
export default class APIRequest {
    ...
    public constructor(rest: RequestHandlerClass, method: RequestMethod, options: RequestOptions) {
