...
export default class extends Command {
    ...
    async execute(message: Message, argv: Arguments) {
        ...
        const commands = this.client.commands
            ...
            .filter((command) => !(!command.config.ownerOnly && this.client.config.ownerID.includes(message.author.id)))
        ...
        if (name) {
            ...
            if (command && !(!message.guild && command.config.guildOnly)) {
                ...
                const embed = new MessageEmbed()
                    ...
                    .addField('User Permission', command.config.permission, true)
        ...
        message.channel.send(
            new MessageEmbed()
                ...
                .setTitle('Xetha Bot')
                .setDescription(`Website ${this.client.xetha.website}\nSupport Server ${this.client.xetha.support.invite}`)
