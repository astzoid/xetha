  ...
  return (
    <Content>
      ...
      <Container className={classes.center}>
        <Avatar alt="Xetha logo" src="logo.webp" className={classes.logo} />
        <Typography color="textPrimary" component="h1" variant="h2">
          Xetha Bot
        </Typography>
        <Typography className={classes.margin} color="textSecondary">
          A super advanced multi-purpose discord bot to enhance your discord
      ...
      >
        ...
        <FeatureCard color="blue" title="Web Dashboard" Icon={BuildIcon}>
          With our powerful intuitive dashboard you can now configure almost
          every aspect of the bot to your preferences
        </FeatureCard>
        <FeatureCard color="yellow" title="Logging" Icon={CloudIcon}>
          A feature that allows you to log almost every action done in your
          server with ease and time efficiency
        </FeatureCard>
        <FeatureCard color="green" title="Active Support" Icon={PeopleIcon}>
          Xetha is user driven meaning your suggestions and requests come to
          life quickly and effectively.
        </FeatureCard>
        <FeatureCard color="pink" title="99.99% Uptime" Icon={VerifiedUserIcon}>
          With incredibly low latency with flawless up-times, Xetha puts your
          community at rest - 24/7
        </FeatureCard>
      </Grid>
    </Content>
  );
