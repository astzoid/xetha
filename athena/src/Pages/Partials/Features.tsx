        ...
        <Container className={styles.center}>
            <Sensor once onChange={(visible) => setFeat(visible)}>
                <Fade timeout={400} in={feat}>
                    <Typography color="textPrimary" component="h2" variant="h5">Features</Typography>
                </Fade>
            </Sensor>
                        ...
                        <Card className={`${styles.redBottom} ${styles.card}`}>
                            <CardContent>
                                ...
                                <Typography variant="body2" component="p" color="textSecondary">
                                    Simple yet, cool moderation utilities with our warning system to punish those rule breakers with our simple moderation commands.
                                </Typography>
                            </CardContent>
                        </Card>
                    </Grow>
                    ...
                    <Grow timeout={400} in={two}>
                        <Card className={`${styles.blueBottom} ${styles.card}`}>
                            <CardContent>
                                ...
                                <Typography variant="body2" component="p" color="textSecondary">
                                    With our powerful intuitive dashboard you can now configure almost every aspect of the bot to your preferences.
                                </Typography>
                            </CardContent>
                        </Card>
                    </Grow>
                    ...
                    <Grow timeout={400} in={three}>
                        <Card className={`${styles.yellowBottom} ${styles.card}`}>
                            <CardContent>
                                ...
                                <Typography variant="body2" component="p" color="textSecondary">
                                    A feature that allows you to log almost every action done in your server with ease and time efficiency
                                </Typography>
                            </CardContent>
                        </Card>
                    </Grow>
                    ...
                    <Grow timeout={400} in={four}>
                        <Card className={`${styles.greenBottom} ${styles.card}`}>
                            <CardContent>
                                ...
                                <Typography variant="body2" component="p" color="textSecondary">
                                    Xetha is user driven meaning your suggestions and requests come to life quickly and effectively.
                                </Typography>
                            </CardContent>
                        </Card>
                    </Grow>
                    ...
                    <Grow timeout={400} in={five}>
                        <Card className={`${styles.pinkBottom} ${styles.card}`}>
                            <CardContent>
                                ...
                                <Typography variant="body2" component="p" color="textSecondary">
                                    With incredibly low latency with flawless up-times, Xetha puts your community at rest - 24/7
                                </Typography>
                            </CardContent>
                        </Card>
                    </Grow>
