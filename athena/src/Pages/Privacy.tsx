  ...
  return (
    <Content>
      <Meta
        ...
        description="The Privacy Policy Notice of Xetha"
        url="/privacy"
      ...
      <Container>
        ...
        <Container>
          <Typography className={styles.mt} color="textSecondary">
            Your privacy is important to us. It is Xetha Development's policy to
            respect your privacy regarding any information we may collect from
            you across our website/services, and other sites we own and operate.
          </Typography>
          <Typography className={styles.mt} color="textSecondary">
