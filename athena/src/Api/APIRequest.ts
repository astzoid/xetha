import type { RequestHandlerClass, RequestMethod, Data, RequestOptions } from './RequestHandler';
import querystring from 'querystring';

export default class APIRequest {

    constructor(rest: RequestHandlerClass, method: RequestMethod, options: RequestOptions) {
